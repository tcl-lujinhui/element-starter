...
export default {
  ...
  methods: {
    ...
    change2gChannelArray (){
      this.page.channelArray['2G']=this.countryCode.countryCode[this.formData.AP2G.CountryCode][0]
    },
    change5gChannelArray (){
      this.page.channelArray['5G']=this.countryCode.country5gChannel[this.formData.AP5G.CountryCode]
    },
    update (){
      let setForm = () => {        
